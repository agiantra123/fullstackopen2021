...
describe('addition of a new blog', () => {
  ...
  test('a valid blog with missing likes property can be added to be zero like', async () => {
    const newBlog = {
      title:
  ...
  test('a blog with missing title property return 404', async () => {
    const newBlog = {
      author: 'Angus Watson',
      url: 'https://edition.cnn.com/2021/09/04/asia/new-zealand-attacker-intl-hnk/index.html',
      likes: 90,
  ...
  test('a blog with missing url property return 404', async () => {
    const newBlog = {
      title:
        "New York City's illegally converted apartments proved deadly in Ida's path",
      author: 'Angus Watson',
